...
class ChatStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamMessages = channel.unary_stream(
                ...
                response_deserializer=chat__pb2.ChatRequest.FromString,
                )
...
def add_ChatServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamMessages': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=chat__pb2.ChatRequest.SerializeToString,
            ),
...
class Chat(object):
    ...
    def StreamMessages(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Chat/StreamMessages',
            chat__pb2.Empty.SerializeToString,
            chat__pb2.ChatRequest.FromString,
